...
def load_sw003_live_gate_evaluation_receipt(path: Path) -> dict[str, Any]:
    from schauwerk.operator.sw003_closeout import (
        load_sw003_live_gate_evaluation_receipt as _impl,
    )
...
def compile_sw003_live_gate_status_receipt(
    *, evaluation_receipt: dict[str, Any], output_path: Path | None = None
    ...
    from schauwerk.operator.sw003_closeout import (
        compile_sw003_live_gate_status_receipt as _impl,
    )

    return _impl(evaluation_receipt=evaluation_receipt, output_path=output_path)


def load_sw003_live_gate_status_receipt(path: Path) -> dict[str, Any]:
    from schauwerk.operator.sw003_closeout import (
        load_sw003_live_gate_status_receipt as _impl,
    )
...
def load_sw003_live_gate_review_packet(path: Path) -> dict[str, Any]:
    from schauwerk.operator.sw003_closeout import (
        load_sw003_live_gate_review_packet as _impl,
    )
...
def compile_sw003_live_gate_evidence_packet(
    *, review_packet: dict[str, Any], output_path: Path | None = None
    ...
    from schauwerk.operator.sw003_closeout import (
        compile_sw003_live_gate_evidence_packet as _impl,
    )
